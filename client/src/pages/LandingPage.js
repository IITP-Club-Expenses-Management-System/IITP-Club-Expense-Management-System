                ...
                >
                    <div className="flex">
                        <h1 className="text-rp-yellow text-3xl font-semibold pt-4">
                            IITP Clubs Expense Management System
                        </h1>
                        <button
                        ...
                        >
                            ...
                            {isMobile ? (
                                <img src={Menu} className="h-10 w-10 p-2 " alt="" />
                            ) : (
                                <img src={Close} className="h-10 w-10 p-3 " alt="" />
                            )}
                        </button>
                    </div>
                    <div
            ...
            <div className="lg:grid lg:grid-cols-2 text-slate-300 lg:h-5/6 mt-32 lg:mt-0">
                <div className="my-auto">
                    <div className="lg:text-6xl lg:py-3 text-2xl p-1">
                        Clubs Expense Management System of{" "}
